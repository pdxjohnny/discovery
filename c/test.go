...
func main() {
	...
	encryptedmsg, err := rsa.EncryptOAEP(sha256.New(), rand.Reader, publickey, msg, label)
	...
	// DecryptOAEP
	decryptedmsg, err := rsa.DecryptOAEP(sha256.New(), rand.Reader, privatekey, encryptedmsg, label)
